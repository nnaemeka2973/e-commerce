      ...
      {cartProduct.length > 0 ? (
        <>
          ...
          lg:items-start lg:gap-x-12 xl:gap-x-16">
            ...
            <section className="mt-16 rounded-lg bg-gray-50
             px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
              ...
              <dl className="mt-6 space-y-4">
                ...
                justify-between border-t border-gray-200 pt-4">
        ...
        <div className="bg-white h-96 flex flex-col gap-2 
        items-center justify-center py-5 rounded-lg border
         border-gray-200 drop-shadow-2xl">
          <h1 className="text-3xl font-bold tracking-tight
           text-gray-900 sm:text-4xl">
            Shopping Cart
          </h1>
          <p className="text-lg max-w-150 text-center
           text-gray-600 tracking-wide leading-6">
