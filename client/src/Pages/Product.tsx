                ...
                <div>
                  {productData?.images?.map((item, index) => (
                    <img
                      ...
                      alt="img"
                      key={index}
                      className={`w-24 cursor-pointer opacity-80
               ...
               <p className="flex items-center">
                ...
                <p>
                 ...
                 <AddToCartBtn
                  product={productData}
                  title="Buy now"
                  className="bg-black/80 py-3 text-base text-gray-200 
                  hover:scale-100 hover:text-white duration-200"
                />
                <div className="bg-[#f7f7f7] p-5 rounded-md flex 
